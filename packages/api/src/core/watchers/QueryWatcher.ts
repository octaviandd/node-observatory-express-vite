...
//   protected async getTableData(filters: QueryFilters): Promise<{ results: any, count: string }> {
...
//   protected extractFiltersFromRequest(req: ObservatoryBoardRequest): QueryFilters {
//     return {
