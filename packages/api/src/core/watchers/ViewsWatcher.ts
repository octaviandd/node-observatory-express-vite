...
class ViewWatcher extends BaseWatcher {
  ...
  protected async getTableData(filters: ViewFilters): Promise<{ results: any, count: string }> {
  ...
  protected extractFiltersFromRequest(req: ObservatoryBoardRequest): ViewFilters {
    return {
