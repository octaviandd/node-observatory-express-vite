...
class ModelWatcher extends BaseWatcher {
  ...
  protected async getTableData(filters: ModelFilters): Promise<{ results: any, count: string }> {
  ...
  protected extractFiltersFromRequest(req: ObservatoryBoardRequest): ModelFilters {
    return {
