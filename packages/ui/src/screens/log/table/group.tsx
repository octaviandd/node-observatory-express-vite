...
export const GroupTable = memo(
  ({ data, children }: { data: LogGroupResponse[]; children: ReactNode }) => {
    return (
              ...
              <TableRow key={log.message}>
                ...
                <TableCell>
                  <div className="flex gap-2">
                    <Badge
                      variant={
                        LOG_LEVELS.find((level) => level.dataKey === "info")
                          ?.variant
                      }
                    ...
                    <Badge
                      variant={
                        LOG_LEVELS.find((level) => level.dataKey === "warn")
                          ?.variant
                      }
                      className="flex gap-1 items-center"
                    >
                    ...
                    <Badge
                      variant={
                        LOG_LEVELS.find((level) => level.dataKey === "error")
                          ?.variant
                      }
                      className="flex gap-1 items-center"
                    >
                    ...
                    <Badge
                      variant={
                        LOG_LEVELS.find((level) => level.dataKey === "debug")
                          ?.variant
                      }
                      className="flex gap-1 items-center"
                    >
                    ...
                    <Badge
                      variant={
                        LOG_LEVELS.find((level) => level.dataKey === "trace")
                          ?.variant
                      }
                      className="flex gap-1 items-center"
                    >
                    ...
                    <Badge
                      variant={
                        LOG_LEVELS.find((level) => level.dataKey === "fatal")
                          ?.variant
                      }
                      className="flex gap-1 items-center"
                    >
                    ...
                    <Badge
                      variant={
                        LOG_LEVELS.find((level) => level.dataKey === "log")
                          ?.variant
                      }
                      className="flex gap-1 items-center"
                    >
